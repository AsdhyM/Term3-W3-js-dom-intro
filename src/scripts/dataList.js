...
function renderData() {
    ...
    dataArray.forEach((car) => {
        ...
        // Create a new HTML alement to help us format the data's valuye
...
function addCarToDataList(event, targetInputId){
    ...
    // Use the form element.checkVadility() method and save the result
    ...
    //  alert("Submitted a new entry: " + dataArray[dataArray.length - 1]);
     ...
     // Clear out the input field text to the blank again
